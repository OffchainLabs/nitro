...
var (
	_ l2stateprovider.Provider                = (*StateManager)(nil)
...
// CollectMachineMashes Collects a list of machine hashes at a message number based on some configuration parameters.
func (s *StateManager) CollectMachineMashes(
