...
type CachingConfig struct {
	...
	StylusLRUCacheSize                 uint32        `koanf:"stylus-lru-cache-size"`
...
func CachingConfigAddOptions(prefix string, f *flag.FlagSet) {
	...
	f.Uint32(prefix+".stylus-lru-cache-size", DefaultCachingConfig.StylusLRUCacheSize, "capacity, in bytes, of the LRU cache that keeps initialized stylus programs")
...
var DefaultCachingConfig = CachingConfig{
	...
	StylusLRUCacheSize:                 256 * 10 * 1024,
