...
func (r *BlockRecorder) RecordBlockCreation(
	...
	return stopwaiter.LaunchPromiseThread(r.execEngine, func(ctx context.Context) (*execution.RecordResult, error) {
		...
		if pos != 0 {
			prevHeader = r.execEngine.bc.GetHeaderByNumber(blockNum - 1)
			if prevHeader == nil {
		...
		canonicalHash := r.execEngine.bc.GetCanonicalHash(blockNum)
...
func (r *BlockRecorder) PrepareForRecord(start, end arbutil.MessageIndex) containers.PromiseInterface[struct{}] {
	return stopwaiter.LaunchPromiseThread(r.execEngine, func(ctx context.Context) (struct{}, error) {
