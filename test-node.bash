...
if $force_init; then
    ...
    docker-compose run --entrypoint bin/deploy poster --l1conn ws://geth:8546 --l1keystore /l1keystore --l1DeployAccount $sequenceraddress --l1deployment /config/deployment.json --authorizevalidators 10 --wasmrootpath /home/user/target/machines
