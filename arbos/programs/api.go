...
type captureHostioType func(name string, args, outs []byte, ink uint64)
...
func newApiClosures(
	...
	captureHostio := func(name string, args, outs []byte, ink uint64) {
		tracingInfo.Tracer.CaptureStylusHostio(name, args, outs, ink)
	}
