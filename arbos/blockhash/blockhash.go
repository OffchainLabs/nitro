...
func (bh *Blockhashes) RecordNewL1Block(tracer *tracing.Hooks, number uint64, blockHash common.Hash, arbosVersion uint64) error {
	...
	storage.CaptureStorageOffset(tracer, &bh.l1BlockNumber, false)
