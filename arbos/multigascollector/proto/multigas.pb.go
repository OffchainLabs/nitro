...
type MultiGasData struct {
	...
	WasmComputation uint64                 `protobuf:"varint,9,opt,name=wasm_computation,json=wasmComputation,proto3" json:"wasm_computation,omitempty"`
...
const file_arbos_multigascollector_proto_multigas_proto_rawDesc = "" +
	"\n" +
	",arbos/multigascollector/proto/multigas.proto\x12\x0emultigas.proto\"\xe5\x02\n" +
	...
	"l2Calldata\x12)\n" +
	"\x10wasm_computation\x18\t \x01(\x04R\x0fwasmComputationB\n" +
	"\n" +
	"\b_unknownB\t\n" +
	"\a_refund\"\x88\x01\n" +
