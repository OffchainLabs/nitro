...
def go_dependencies():
    ...
    go_repository(
        ...
        sum = "h1:HrPv5zFZT1Nw5uSzTQ0Z5wCQhFVORQFib5TCFoMY0oE=",
        version = "v0.0.0-20230310045829-43e78dfbcee7",
    )
    ...
    go_repository(
        ...
        sum = "h1:KafLifaRFIuSJ5C+7CyFJOF9haxKNC1CEIDk8GX6X0k=",
        version = "v0.0.0-20220920183852-bf014ff85ad5",
    )
    go_repository(
