...
func GetLogTransaction(ctx context.Context, client chainifaces.EthereumReadWriter, log types.Log) (*types.Transaction, error) {
...
func GetLogEmitterTxData(ctx context.Context, client chainifaces.EthereumReadWriter, log types.Log) ([]byte, error) {
