...
func startup() error {
	...
	if serverConfig.EnableRPC {
		...
		rpcServer, err = das.StartDASRPCServer(ctx, serverConfig.RPCAddr, serverConfig.RPCPort, serverConfig.RPCServerTimeouts, daReader, daWriter, daHealthChecker, signatureVerifier)
		if err != nil {
			return err
		}
	}
