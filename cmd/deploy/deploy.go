...
func main() {
	...
	l1conn := flag.String("l1conn", "https://goerli-rollup.arbitrum.io/rpc", "l1 connection")
	l1keystore := flag.String("l1keystore", "/Users/amansanghi/Library/Ethereum/keystore", "l1 private key store")
	deployAccount := flag.String("l1DeployAccount", "", "l1 seq account to use (default is first account in keystore)")
	ownerAddressString := flag.String("ownerAddress", "0xDA4cA7F538bc88Ad24CFB09e219Fdb2382eFb1CC", "the rollup owner's address")
