...
type L2Config struct {
	...
	// Generated by combining ChainInfoFiles with the downloaded ChainInfoIpfsUrl if present
	// We'd make this field public, but then koanf would parse it
	combinedChainInfoFiles []string
}

func (c *L2Config) SetCombinedChainInfoFiles(combinedChainInfoFiles []string) {
	c.combinedChainInfoFiles = combinedChainInfoFiles
}

func (c *L2Config) CombinedChainInfoFiles() []string {
	return c.combinedChainInfoFiles
}
...
var L2ConfigDefault = L2Config{
	...
	ChainInfoIpfsUrl:          "",
	ChainInfoIpfsDownloadPath: "ipfs",
}
...
func L2ConfigAddOptions(prefix string, f *flag.FlagSet) {
	...
	f.String(prefix+".chain-info-ipfs-download-path", L2ConfigDefault.ChainInfoIpfsDownloadPath, "folder to save chain information downloaded from IPFS in")
