...
func TestL3ChallengeProtocolBOLD(t *testing.T) {
	...
	go keepChainMoving(t, ctx, 3*time.Second, builder.L1Info, builder.L1.Client) // Advance L1.
	go keepChainMoving(t, ctx, 3*time.Second, builder.L2Info, builder.L2.Client) // Advance L2.
