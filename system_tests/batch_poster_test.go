...
func testBatchPosterParallel(t *testing.T, useRedis bool) {
	...
	if false {
		...
		Require(t, err)
		seqInbox, err := arbnode.NewSequencerInbox(builder.L1.Client, builder.L2.ConsensusNode.DeployInfo.SequencerInbox, builder.L2.ConsensusNode.DeployInfo.LegacySequencerInbox, builder.L2.ConsensusNode.DeployInfo.Bridge, 0)
		Require(t, err)
