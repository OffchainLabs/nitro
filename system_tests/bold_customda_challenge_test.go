...
import (
	...
	"github.com/offchainlabs/bold/challenge_testing/setup"
	"github.com/offchainlabs/bold/challengemanager"
	modes "github.com/offchainlabs/bold/challengemanager/types"
	"github.com/offchainlabs/bold/l2stateprovider"
	"github.com/offchainlabs/bold/protocol/solimpl"
...
func createNodeBWithSharedContracts(
	...
	execNode, err := gethexec.CreateExecutionNode(ctx, l2stack, l2chainDb, l2blockchain, l1client, execConfigFetcher, big.NewInt(1337), 0)
	Require(t, err)
