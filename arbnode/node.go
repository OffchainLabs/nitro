...
func createNodeImpl(
	...
	if config.Staker.Enable {
		...
		stakerObj, err = staker.NewStaker(l1Reader, wallet, bind.CallOpts{}, config.Staker, blockValidator, statelessBlockValidator, deployInfo.ValidatorUtils, fatalErrChan)
		if err != nil {
			return nil, err
		}
