...
func TestExtractMessages(t *testing.T) {
	...
	tests := []struct {
		...
		parseSequencerMsg    func(context.Context, uint64, common.Hash, []byte, *daprovider.DAProviderRegistry, daprovider.KeysetValidationMode) (*arbstate.SequencerMessage, error)
