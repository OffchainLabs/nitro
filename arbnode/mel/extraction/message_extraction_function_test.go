...
func TestExtractMessages(t *testing.T) {
	...
	tests := []struct {
		...
		parseSequencerMsg    func(context.Context, uint64, common.Hash, []byte, *daprovider.ReaderRegistry, *arbstate.BatchPayloadMap, daprovider.KeysetValidationMode) (*arbstate.SequencerMessage, error)
...
func successfulParseSequencerMsg(
	...
	cachedPayloads *arbstate.BatchPayloadMap,
