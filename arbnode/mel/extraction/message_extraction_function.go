...
// an input MEL state to run a specific algorithm that extracts Arbitrum messages and
...
// extractMessagesImpl is the unexported core of ExtractMessages. All higher-order
// functions are injected as parameters to allow unit testing without RPC mocks.
// Production callers should use ExtractMessages.
