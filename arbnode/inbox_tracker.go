...
type InboxTracker struct {
	...
	eigenda    arbstate.EigenDADataAvailabilityReader

	batchMetaMutex sync.Mutex
	batchMeta      *containers.LruCache[uint64, BatchMetadata]
}

func NewInboxTracker(db ethdb.Database, txStreamer *TransactionStreamer, das arbstate.DataAvailabilityReader, eigenda arbstate.EigenDADataAvailabilityReader) (*InboxTracker, error) {
