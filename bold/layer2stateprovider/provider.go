...
// Package layer2stateprovider defines a dependency which provides L2 states and
...
// execution states, prefix proofs, and more for the BoLD chainabstraction.
...
type ExecutionProvider interface {
	...
	ExecutionStateAfterPreviousState(ctx context.Context, maxInboxCount uint64, previousGlobalState chainabstraction.GoGlobalState) (*chainabstraction.ExecutionState, error)
}
