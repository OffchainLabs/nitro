...
// and to be less than the total number of challenge levels in the chainabstraction.
...
func (p *HistoryCommitmentProvider) OneStepProofData(
	...
	startHeights []Height,
	upToHeight Height,
) (*chainabstraction.OneStepData, []common.Hash, []common.Hash, error) {
	...
	data := &chainabstraction.OneStepData{
...
// levels in the chainabstraction.
...
// The total number of challenge levels in the chainabstraction.
