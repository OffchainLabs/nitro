...
// assertions.
func (m *Manager) HandleCorrectRival(ctx context.Context, riv chainabstraction.AssertionHash) error {
...
func (m *Manager) ChallengeAssertion(ctx context.Context, id chainabstraction.AssertionHash) (bool, error) {
...
func (m *Manager) addBlockChallengeLevelZeroEdge(
...
) (chainabstraction.VerifiedRoyalEdge, bool, *layer2stateprovider.AssociatedAssertionMetadata, bool, error) {
	...
	req := &layer2stateprovider.HistoryCommitmentRequest{
		AssertionMetadata:           assertionMetadata,
		UpperChallengeOriginHeights: []layer2stateprovider.Height{},
		UpToHeight:                  option.Some(layer2stateprovider.Height(layerZeroHeights.BlockChallengeHeight)),
	}
	...
	precomputedEdgeId, err := manager.CalculateEdgeId(
		...
		chainabstraction.OriginId(creationInfo.ParentAssertionHash.Hash),
