...
import (
	...
	boldtime "github.com/offchainlabs/nitro/bold/time"
)
...
func WithTimeReference(ref boldtime.Reference) Opt {
...
func New(
	...
	tr := &Tracker{
		...
		timeRef:                     boldtime.NewRealTimeReference(),
	}
	for _, o := range opts {
		o(tr)
	}
