...
func setupAssertionChain(
	...
	opts ...solimplementation.Opt,
) *solimplementation.AssertionChain {
	t.Helper()
	...
	require.NoError(t, err)
	chain, err := solimplementation.NewAssertionChain(
		ctx,
		rollup,
...
func totalWasmOpcodes(heights *chainabstraction.LayerZeroHeights, numBigSteps uint8) uint64 {
...
var (
	_ chainabstraction.ChainBackend = &FlakyEthClient{}
)
