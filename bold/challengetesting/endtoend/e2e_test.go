...
func runEndToEndTest(t *testing.T, cfg *e2eConfig) {
	...
	challengeTestingOpts := []challengetesting.Opt{
		challengetesting.WithConfirmPeriodBlocks(cfg.protocol.challengePeriodBlocks),
		challengetesting.WithLayerZeroHeights(&cfg.protocol.layerZeroHeights),
		challengetesting.WithNumBigStepLevels(cfg.protocol.numBigStepLevels),
	}
