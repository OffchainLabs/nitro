...
func (l *LocalSimulatedBackend) Client() chainabstraction.ChainBackend {
...
func (l *LocalSimulatedBackend) DeployRollup(_ context.Context, _ ...challengetesting.Opt) (*setup.RollupAddresses, error) {
