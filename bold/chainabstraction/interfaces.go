...
// which is used for all challenges in the chainabstraction.
...
// ChallengeLevel corresponds to the different challenge levels in the chainabstraction.
...
// EdgeStatus of an edge in the chainabstraction.
