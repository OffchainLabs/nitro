...
#[allow(dead_code)]
extern "C" {
    pub fn wavm_caller_module_memory_load8(ptr: usize) -> u8;
    pub fn wavm_caller_module_memory_load32(ptr: usize) -> u32;
    pub fn wavm_caller_module_memory_store8(ptr: usize, val: u8);
    pub fn wavm_caller_module_memory_store32(ptr: usize, val: u32);

    pub fn wavm_guest_call__getsp() -> usize;
    pub fn wavm_guest_call__resume();
}

pub unsafe fn wavm_caller_module_memory_load64(ptr: usize) -> u64 {
...
pub unsafe fn wavm_caller_module_memory_store64(ptr: usize, val: u64) {
...
impl GoStack {
    ...
    pub unsafe fn read_u8(self, arg: usize) -> u32 {
        wavm_caller_module_memory_load32(self.offset(arg))
    }
    ...
    pub unsafe fn read_u64(self, arg: usize) -> u64 {
        wavm_caller_module_memory_load64(self.offset(arg))
    }

    pub unsafe fn write_u8(self, arg: usize, x: u8) {
        wavm_caller_module_memory_store8(self.offset(arg), x);
    }

    pub unsafe fn write_u32(self, arg: usize, x: u32) {
        wavm_caller_module_memory_store32(self.offset(arg), x);
    }

    pub unsafe fn write_u64(self, arg: usize, x: u64) {
        wavm_caller_module_memory_store64(self.offset(arg), x);
    }
}
