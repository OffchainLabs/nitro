...
func JitSpawnerConfigAddOptions(prefix string, f *flag.FlagSet) {
	...
	f.Duration(prefix+"max_execution_time", DefaultJitSpawnerConfig.MaxExecutionTime, "if execution time used by a jit wasm exceeds this limit, a rpc error is returned")
}
