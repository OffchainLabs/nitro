...
var (
	...
	ConsensusExecutionUseRPC                      = fs.Bool("consensus_execution_in_same_process_use_rpc", false, "Whether to enable communication between consensus and execution side of a node via json rpc")
)
