...
module.exports.tags = ["OneStepProofEntryStubbedInbox", "test"];
module.exports.dependencies = ["OneStepProver0", "OneStepProverMemory", "OneStepProverMath", "OneStepProverHostIoStubbedInbox"];
