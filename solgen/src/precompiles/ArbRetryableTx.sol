...
interface ArbRetryableTx {
    ...
    */
    ...
    event RedeemScheduled(bytes32 indexed ticketId, bytes32 indexed redeemTxId, uint64 sequenceNum, uint64 donatedGas, address gasDonor, bytes32 indexed retryTxHash);
