...
contract RollupAdminLogic is RollupCore, IRollupAdmin, SecondaryLogicUUPSUpgradeable {
    ...
    modifier isInitAfterExec {
        _;
        require(isInit(), "METHOD_REMOVES_INIT");
    }
     ...
     */
    function setOutbox(IOutbox _outbox) external override isInitAfterExec {
        outbox = _outbox;
     ...
     */
    function removeOldOutbox(address _outbox) external override isInitAfterExec {
     ...
     */
    function setInbox(address _inbox, bool _enabled) external override isInitAfterExec {
     ...
     */
    function pause() external override isInitAfterExec {
        _pause();
     ...
     */
    function resume() external override isInitAfterExec {
        _unpause();
     ...
     */
    function setValidator(address[] calldata _validator, bool[] calldata _val) external override isInitAfterExec {
     ...
     */
    function setOwner(address newOwner) external override isInitAfterExec {
     ...
     */
    function setMinimumAssertionPeriod(uint256 newPeriod) external override isInitAfterExec {
     ...
     */
    function setConfirmPeriodBlocks(uint64 newConfirmPeriod) external override isInitAfterExec {
     ...
     */
    function setExtraChallengeTimeBlocks(uint64 newExtraTimeBlocks) external override isInitAfterExec {
     ...
     */
    function setBaseStake(uint256 newBaseStake) external override isInitAfterExec {
     ...
     */
    function setStakeToken(address newStakeToken) external override whenPaused isInitAfterExec {
        /*
     ...
     */
    function setSequencerInboxMaxTimeVariation(ISequencerInbox.MaxTimeVariation calldata maxTimeVariation)
        external
        override
        isInitAfterExec
    {
     ...
     */
    function setIsBatchPoster(address addr, bool isBatchPoster) external override isInitAfterExec {
     ...
     */
    function upgradeBeacon(address beacon, address newImplementation) external override isInitAfterExec {
    ...
    function forceRefundStaker(address[] calldata staker) external override whenPaused isInitAfterExec {
    ...
    ) external override whenPaused isInitAfterExec {
    ...
    function setLoserStakeEscrow(address newLoserStakerEscrow) external override isInitAfterExec {
     ...
     */
    function setWasmModuleRoot(bytes32 newWasmModuleRoot) external override isInitAfterExec {
