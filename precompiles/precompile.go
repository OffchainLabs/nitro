...
func Precompiles() map[addr]ArbosPrecompile {
	...
	ArbOwner.methodsByName["SetTipCapFloor"].arbosVersion = params.ArbosVersion_60
	...
	ArbOwnerPublic.methodsByName["GetTipCapFloor"].arbosVersion = params.ArbosVersion_60
