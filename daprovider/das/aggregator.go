...
type ServiceDetails struct {
	service     dasutil.AnyTrustWriter
...
func NewServiceDetails(service dasutil.AnyTrustWriter, pubKey blsSignatures.PublicKey, signersMask uint64, metricName string) (*ServiceDetails, error) {
