...
library ChallengeManagerLib {
    ...
    function checkConfirmForPsTimer(
        ...
        require(
            vertexManager.getCurrentPsTimer(vId) > challengePeriod,
    ...
    function checkCreateSubChallenge(
        ...
        require(
            !vertexManager.hasConfirmablePsAt(vId, challengePeriod),
