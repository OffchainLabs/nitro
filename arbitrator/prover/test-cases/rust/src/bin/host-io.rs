...
const INBOX_HEADER_LEN: usize = 40; // also in src/main.rs & solgen's OneStepProverHostIo.sol
const DELAYED_HEADER_LEN: usize = 112; // also in src/main.rs & solgen's OneStepProverHostIo.sol
