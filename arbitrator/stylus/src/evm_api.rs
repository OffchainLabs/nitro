...
pub struct NativeRequestHandler {
    pub handle_request: unsafe extern "C" fn(id: usize, req_type: u32, data: *mut RustSlice, gas_cost: *mut u64, output: *mut RustBytes) -> EvmApiStatus, // value
    pub id: usize,
}
...
impl RequestHandler for NativeRequestHandler {
    fn handle_request(&mut self, req_type: EvmApiMethod, req_data: &[u8]) -> (Vec<u8>, u64) {
        ...
        let mut cost = 0;
        call!(self, handle_request, req_type as u32 + 0x10000000, ptr!(RustSlice::new(req_data)), ptr!(cost), ptr!(output));
