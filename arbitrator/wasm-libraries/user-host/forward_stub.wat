...
(module
    ...
    (func (export "vm_hooks__return_data")            (param i32 i32) unreachable)
    (func (export "vm_hooks__account_load_bytes32")   (param i32 i32) unreachable)
    (func (export "vm_hooks__account_store_bytes32")  (param i32 i32) unreachable)
    ...
    (func (export "vm_hooks__read_return_data")       (param i32) unreachable)
    ...
    (func (export "vm_hooks__block_chainid")          (param i32) unreachable)
