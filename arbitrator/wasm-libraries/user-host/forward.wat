...
(module
    ...
    (export "vm_hooks__return_data"            (func $return_data))
    (export "vm_hooks__account_load_bytes32"   (func $account_load_bytes32))
    (export "vm_hooks__account_store_bytes32"  (func $account_store_bytes32))
    ...
    (export "vm_hooks__block_chainid"          (func $block_chainid))
