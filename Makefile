...
arbutil_files = $(wildcard arbitrator/arbutil/src/*.* arbitrator/arbutil/*.toml)

prover_src = arbitrator/prover/src
arbitrator_prover_files = $(wildcard $(prover_src)/*.* $(prover_src)/*/*.* arbitrator/prover/*.toml) $(arbutil_files)
...
$(arbitrator_prover_bin): $(DEP_PREDICATE) $(arbitrator_prover_files)
...
$(arbitrator_prover_lib): $(DEP_PREDICATE) $(arbitrator_prover_files)
